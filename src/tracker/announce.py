...
async def announce(TorrentData: Torrent, downloaded: int, uploaded: int, left: int, port: int, event: int) -> List[Tuple[str, int]]:
    """
    performs announce request to trackers
    :param TorrentData: a torrent object from torrent file
